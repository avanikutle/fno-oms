    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            if ("/search".equals(path)) {
                ...
                List<Map<String, String>> results = ScripMasterService.searchOptions(query);
        ...
        try {
            ...
            if ("/watchlist".equals(path)) {
                ...
                if (!list.contains(symbol)) {
                    list.add(symbol);
                    kvDao.setValue("algo.strategy.watchlist", String.join(",", list), "SYSTEM");
                ...
                ScripMasterService.initActiveTokens(list);
                ...
                config.setToken(ScripMasterService.getToken(symbol));
